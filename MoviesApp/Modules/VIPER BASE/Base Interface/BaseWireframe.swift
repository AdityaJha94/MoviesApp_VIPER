...
extension UIViewController {
    ...
    func presentWireframeWithNavigationBar(_ wireframe: BaseWireframe, animated: Bool = true, completion: (() -> Void)? = nil) {
        let navigationController = UINavigationController.init(rootViewController: wireframe.viewController)
